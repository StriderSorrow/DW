...
namespace DW.Data.Migrations
{
    ...
    [Migration("20230519081141_Confirmation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DW.Data.Database.Entities.DwMedia", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("DwCharacterDwMedia", b =>
                {
                    b.Property<string>("DwCharacterId")
                        .HasColumnType("text");

                    b.Property<string>("MediasId")
                        .HasColumnType("text");

                    b.HasKey("DwCharacterId", "MediasId");

                    b.HasIndex("MediasId");

                    b.ToTable("DwCharacterDwMedia");
                });
            ...
            modelBuilder.Entity("DwMediaDwProject", b =>
                {
                    b.Property<string>("DwProjectId")
                        .HasColumnType("text");
                    ...
                    b.HasKey("DwProjectId", "MediasId");

                    b.HasIndex("MediasId");

                    b.ToTable("DwMediaDwProject");
                });

            modelBuilder.Entity("DwMediaDwTeam", b =>
                {
                    b.Property<string>("DwTeamId")
                        .HasColumnType("text");
                    ...
                    b.HasKey("DwTeamId", "MediasId");

                    b.HasIndex("MediasId");

                    b.ToTable("DwMediaDwTeam");
                });

            modelBuilder.Entity("DwMediaDwUser", b =>
                {
                    b.Property<string>("ActorsMediasId")
                        .HasColumnType("text");

                    b.Property<string>("DwUserId")
                        .HasColumnType("text");

                    b.HasKey("ActorsMediasId", "DwUserId");

                    b.HasIndex("DwUserId");

                    b.ToTable("DwMediaDwUser");
                });
            ...
            modelBuilder.Entity("DW.Data.Database.Entities.DwMedia", b =>
                {
                    b.HasOne("DW.Data.Database.Entities.DwUser", "Uploader")
            ...
            modelBuilder.Entity("DwCharacterDwMedia", b =>
                {
                    b.HasOne("DW.Data.Database.Entities.DwCharacter", null)
                        .WithMany()
                        .HasForeignKey("DwCharacterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DW.Data.Database.Entities.DwMedia", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DwMediaDwUser", b =>
                {
                    b.HasOne("DW.Data.Database.Entities.DwMedia", null)
                        .WithMany()
                        .HasForeignKey("ActorsMediasId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DW.Data.Database.Entities.DwUser", null)
                        .WithMany()
                        .HasForeignKey("DwUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
